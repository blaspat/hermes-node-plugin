...
- **Default port:** 7000. Operator's choice — change it via `HERMES_NODES_PORT` if the corporate firewall blocks this port. 443 is the most universally-allowed alternative.
